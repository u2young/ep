 ...
 */
@Component
public class ErpPaymentConfirmHandler implements OperationHandler<Object, Object> {

    public static final String CODE_CONFIRM = "erp.finance.payment.confirm";
    ...
    public String exec(List<Object> data, Object formValue, String[] eruptParams) {
        ...
        for (Object row : data) {
            if (!(row instanceof ErpFinancePayment doc)) {
                fail++;
                sb.append(row.getClass().getSimpleName()).append(": 仅支持付款单; ");
                continue;
            }
            try {
                ...
                fail++;
                sb.append(ErpFinancePayment.class.getSimpleName()).append("#").append(doc.getNo())
