...
@Getter @Setter
@Entity
@Table(name = "erp_purchase_order_item")
@Erupt(name = "采购订单明细")
public class ErpPurchaseOrderItem extends BaseModel {
    ...
    @EruptField(views = @View(title = "采购数量"),
                edit = @Edit(title = "采购数量", notNull = true,
