...
import xyz.herz.ep.erp.enums.ErpDictEnums.*;

/**
 * ERP 通用字典下拉处理器。
 * <p>用法:
 * <pre>
 * &#64;ChoiceType(fetchHandler = ErpEnumChoiceFetchHandler.class, fetchHandlerParams = "AuditStatus")
...
public class ErpEnumChoiceFetchHandler implements ChoiceFetchHandler {
    ...
    private static final Map<String, Enum<?>[]> LOOKUP = Map.ofEntries(
        ...
        Map.entry("ProductListingStatus", ProductListingStatus.values()),
        Map.entry("AuditStatus", AuditStatus.values()),
    ...
    public List<VLModel> fetch(String[] params) {
        ...
        try {
            ...
            throw new IllegalStateException("ERP enum missing code/label: " + key, roe);
        }
        return r;
    }
}
