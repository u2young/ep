package xyz.herz.ep.landing.core;
 ...
 * <p>用法:
 * <pre>
 * &#64;ChoiceType(fetchHandler = LandingEnumChoiceFetchHandler.class, fetchHandlerParams = "PageStatus")
 * private Integer status;
 * </pre>
 * 支持的 key:
 *  PageStatus / TemplateCategory / LeadSource / EnableStatus
 */
public class LandingEnumChoiceFetchHandler implements ChoiceFetchHandler {
    ...
    public List<VLModel> fetch(String[] params) {
        ...
        try {
            ...
            throw new IllegalStateException("Landing enum missing code/label: " + key, roe);
        }
        return r;
    }
}
